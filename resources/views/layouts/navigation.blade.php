<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @endauth
                    <x-nav-link :href="route('games.search')" :active="request()->routeIs('games.*')">
                        Search Games
                    </x-nav-link>
                    @auth
                ...
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('subscription.portal')">
                                Subscription
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endauth
            <x-responsive-nav-link :href="route('games.search')" :active="request()->routeIs('games.*')">
                Search Games
            </x-responsive-nav-link>
            @auth
